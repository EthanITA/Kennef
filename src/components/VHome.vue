<template>
    <v-container class="pt-10 px-16">
        <v-row no-gutters>
            <v-col class="d-flex">
                <v-sheet elevation="0" color="white" class="justify-start align-self-center">
                    <h1 class="text-h1 font-weight-regular">Dal bullone <br /> in su</h1>
                    <p class="text-h6 font-weight-regular ml-1 mt-5">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. <br /> Sint necessitatibus
                        maiores doloremque aut nemo accusantium <br /> excepturi laboriosam expedita dolores id.
                    </p>
                    <v-btn x-large depressed class="rounded-0" color="primary">
                        Vai allo shop
        ...
        <v-lazy>
            <div class="d-flex flex-column info-list pt-16">
                <h2 class="mb-11 text-h5 font-weight-regular align-self-center">
                    Acquista utensili su Kennef
                </h2>
                <v-sheet class="d-flex flex-column align-self-center justify-center mb-11" v-for="card in info"
                    width="300" :key="card.title" elevation="0">
            ...
            <div class="d-flex flex-column brand-list pt-16">
                ...
                <v-row class="flex-child mb-16">
                    <v-col v-for="brand in brands" :key="brand.name" class="d-flex" cols="12" md="2" lg="2" xl="2">
                        <v-img class="mr-10" :src="brand.img" max-width="700">
                        </v-img>
                    </v-col>
                </v-row>
            </div>
